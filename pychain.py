...
#   `Block` consists of an attribute named `record`, which is set equal to a 
#   `Record` that contains the `sender`, `receiver`, and `amount` values. 
...
sender = st.text_input('Address of Sender')

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver = st.text_input('Address of Recipient')
